...
<body>
        ...
        <div class="row">
          ...
          <div class="row">
                  <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="padding-left:50px;">
                      <h1 class="page-header">Day 1 Schedule <small>(9:00 AM Tee Time for everybody)</small></h1>
                  </div>
          </div>
    ...
    <script src="https://spreadsheets.google.com/feeds/cells/1WbKtxXi113DeKitBPMaIVcwwBZRRIUAmiPMHZ5fPSxw/1/public/values?alt=json-in-script&amp;callback=displayContent" type="text/javascript"></script>
